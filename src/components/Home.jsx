    ...
    <div>
      ...
      <div name="home" className="flex flex-col lg:flex-row items-center p-10 lg:p-20 space-y-10 lg:space-x-20 bg-[#0a1828] text-black">
        <div className="lg:w-1/2 ssm:w-full mb-10">
          <p className="text-2xl md:text-4xl lg:text-5xl mb-6 text-[#bfa181] mt-32 font-bold font-sans">Hi,</p>

          <h1 style={{ paddingTop: '2rem', margin: 'auto 0', fontWeight: 'normal', fontSize: '24px', color: 'gold' }}>
            I am, a {' '}
            <span style={{ color: 'red', fontWeight: 'bold', fontSize: '24px' }}>
              <Typewriter
                words={['Digital Marketer', 'Web developer', 'Creative', 'Physicist']}
                loop={5}
                cursor
                cursorStyle="|"
                typeSpeed={70}
          ...
          <hr className="border-t-2 my-5 w-1/4 border-indigo-600" /><br></br>
          <p className="text-sm lg:text-base text-[#bfa181]">
            A Digital Marketing Specialist | A software developer As well As a Mathematician. Here to solve your Marketing
            and Tech problems
          </p>
        ...
        <div className="lg:w-1/2 ssm:w-full mb-12 bg-[#0a1828]">
          <img
            src={Logo}
            alt="kelvin"
