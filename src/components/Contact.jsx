const Contact = () => {
  return (
    <div name='contact' className='w-full bg-[#C0C0C0] flex flex-col md:flex-row justify-center items-center p-4'>
      <form method='POST' action="https://getform.io/f/fadc208b-aa8f-409e-a534-df50ac8b18ba" className='flex flex-col max-w-[600px] w-full md:mr-8'>
        <div className='pb-8'>
          <p className='text-4xl font-bold inline border-b-4 border-pink-600 text-'>Get In Touch</p>
          <p className='text-black py-5'> Submit the form below for inquiries or for business! </p>
        </div>
