...
const Products = () => {
 ...
 Marc & Tech Is Built on a Foundation of Professional Excellence and Integrity
  </p>
  <div className="mt-8">
        <h3 className="text-2xl font-bold">Mission</h3>
        <p className="text-lg mt-2">To empower businesses with innovative marketing and technology solutions that drive growth and foster strong customer relationships.</p>
        
      </div>
      <div className="mt-8">
        <h3 className="text-2xl font-bold">Client Testimonials</h3>
        <div className="mt-4">
          <p className="text-lg italic">"The team at Mark Tech transformed our online presence and boosted our sales!"</p>
          <p className="text-md font-semibold mt-2">- Sarah Jones, CEO of Tech Innovators</p>
        </div>
        <div className="mt-4">
          <p className="text-lg italic">"Their expertise in SEO and digital marketing is unmatched."</p>
          <p className="text-md font-semibold mt-2">- Mark Smith, Marketing Director at Biz Solutions</p>
        </div>
      </div>
  ...
  <div className="p-4 m-2 bg-white text-gray-900 shadow-md rounded-lg">
    ...
    />
    <h3 className="text-lg font-bold">Increased Sales</h3>
    <p>
  ...
  <div className="p-4 m-2 bg-white text-gray-900 shadow-md rounded-lg">
    ...
    <p>
      Our proven techniques ensure your products or services sell out quickly,
